...
| `POST /api/v1/delivery/calculate` | `delivery.handler` | `DeliveryService` | `CartRepository`, `CheckoutDeliveryRepository`, `CdekService` |
| `POST /api/v1/delivery/select` | `delivery.handler` | `DeliveryService` | то же |
| `GET /api/v1/delivery/current` | `delivery.handler` | `DeliveryService` | то же |
...
| `GET /api/v1/orders`, `GET /api/v1/orders/:order_id`, `POST /api/v1/orders/:order_id/cancel` | `order.handler` | `OrderService` | `OrderRepository` |
